...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OriginRESTAPI.parameters'
        db.add_column(u'origins_originrestapi', 'parameters',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OriginRESTAPI.parameters'
        db.delete_column(u'origins_originrestapi', 'parameters')

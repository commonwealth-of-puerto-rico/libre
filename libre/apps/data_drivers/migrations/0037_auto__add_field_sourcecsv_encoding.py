...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceCSV.encoding'
        db.add_column(u'data_drivers_sourcecsv', 'encoding',
                      self.gf('django.db.models.fields.CharField')(default='ascii', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceCSV.encoding'
        db.delete_column(u'data_drivers_sourcecsv', 'encoding')
    ...
    models = {
        ...
        u'data_drivers.sourcedataversion': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 10, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.published'
        db.add_column(u'data_drivers_source', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source.published'
        db.delete_column(u'data_drivers_source', 'published')
    ...
    models = {
        ...
        u'data_drivers.sourcedataversion': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 19, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

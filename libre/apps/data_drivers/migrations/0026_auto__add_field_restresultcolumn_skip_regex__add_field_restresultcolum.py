...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RESTResultColumn.skip_regex'
        db.add_column(u'data_drivers_restresultcolumn', 'skip_regex',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'RESTResultColumn.import_regex'
        db.add_column(u'data_drivers_restresultcolumn', 'import_regex',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RESTResultColumn.skip_regex'
        db.delete_column(u'data_drivers_restresultcolumn', 'skip_regex')

        # Deleting field 'RESTResultColumn.import_regex'
        db.delete_column(u'data_drivers_restresultcolumn', 'import_regex')

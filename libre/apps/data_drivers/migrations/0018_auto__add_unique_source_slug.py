...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Source', fields ['slug']
        db.create_unique(u'data_drivers_source', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Source', fields ['slug']
        db.delete_unique(u'data_drivers_source', ['slug'])

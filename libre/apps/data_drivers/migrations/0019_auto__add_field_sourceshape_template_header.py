...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceShape.template_header'
        db.add_column(u'data_drivers_sourceshape', 'template_header',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceShape.template_header'
        db.delete_column(u'data_drivers_sourceshape', 'template_header')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceShape.popup_template'
        db.add_column(u'data_drivers_sourceshape', 'popup_template',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceShape.popup_template'
        db.delete_column(u'data_drivers_sourceshape', 'popup_template')
    ...
    models = {
        ...
        u'data_drivers.sourcedataversion': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 9, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Source.schedule_hour'
        db.alter_column(u'data_drivers_source', 'schedule_hour', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Source.schedule_week'
        db.alter_column(u'data_drivers_source', 'schedule_week', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Source.schedule_day'
        db.alter_column(u'data_drivers_source', 'schedule_day', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Source.schedule_minute'
        db.alter_column(u'data_drivers_source', 'schedule_minute', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Source.schedule_dow'
        db.alter_column(u'data_drivers_source', 'schedule_dow', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Source.schedule_second'
        db.alter_column(u'data_drivers_source', 'schedule_second', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Source.schedule_year'
        db.alter_column(u'data_drivers_source', 'schedule_year', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Source.schedule_month'
        db.alter_column(u'data_drivers_source', 'schedule_month', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Source.schedule_hour'
        db.alter_column(u'data_drivers_source', 'schedule_hour', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Source.schedule_week'
        db.alter_column(u'data_drivers_source', 'schedule_week', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Source.schedule_day'
        db.alter_column(u'data_drivers_source', 'schedule_day', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Source.schedule_minute'
        db.alter_column(u'data_drivers_source', 'schedule_minute', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Source.schedule_dow'
        db.alter_column(u'data_drivers_source', 'schedule_dow', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Source.schedule_second'
        db.alter_column(u'data_drivers_source', 'schedule_second', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Source.schedule_year'
        db.alter_column(u'data_drivers_source', 'schedule_year', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Source.schedule_month'
        db.alter_column(u'data_drivers_source', 'schedule_month', self.gf('django.db.models.fields.CharField')(max_length=16))
    ...
    models = {
        ...
        u'data_drivers.source': {
            ...
            'schedule_day': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'schedule_dow': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'schedule_hour': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'schedule_minute': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'schedule_month': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'schedule_second': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'schedule_week': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'schedule_year': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
        ...
        u'data_drivers.sourcedataversion': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 19, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

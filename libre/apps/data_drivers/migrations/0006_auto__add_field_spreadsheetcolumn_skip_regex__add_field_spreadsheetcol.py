...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpreadsheetColumn.skip_regex'
        db.add_column(u'data_drivers_spreadsheetcolumn', 'skip_regex',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True, null=True),
                      keep_default=False)

        # Adding field 'SpreadsheetColumn.import_regex'
        db.add_column(u'data_drivers_spreadsheetcolumn', 'import_regex',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpreadsheetColumn.skip_regex'
        db.delete_column(u'data_drivers_spreadsheetcolumn', 'skip_regex')

        # Deleting field 'SpreadsheetColumn.import_regex'
        db.delete_column(u'data_drivers_spreadsheetcolumn', 'import_regex')
    ...
    models = {
        ...
        u'data_drivers.sourcedataversion': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 20, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

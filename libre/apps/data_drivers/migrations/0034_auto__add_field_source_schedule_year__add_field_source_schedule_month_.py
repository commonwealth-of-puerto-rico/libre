...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.schedule_year'
        db.add_column(u'data_drivers_source', 'schedule_year',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'Source.schedule_month'
        db.add_column(u'data_drivers_source', 'schedule_month',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'Source.schedule_day'
        db.add_column(u'data_drivers_source', 'schedule_day',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'Source.schedule_week'
        db.add_column(u'data_drivers_source', 'schedule_week',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'Source.schedule_dow'
        db.add_column(u'data_drivers_source', 'schedule_dow',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'Source.schedule_hour'
        db.add_column(u'data_drivers_source', 'schedule_hour',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'Source.schedule_minute'
        db.add_column(u'data_drivers_source', 'schedule_minute',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'Source.schedule_second'
        db.add_column(u'data_drivers_source', 'schedule_second',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source.schedule_year'
        db.delete_column(u'data_drivers_source', 'schedule_year')

        # Deleting field 'Source.schedule_month'
        db.delete_column(u'data_drivers_source', 'schedule_month')

        # Deleting field 'Source.schedule_day'
        db.delete_column(u'data_drivers_source', 'schedule_day')

        # Deleting field 'Source.schedule_week'
        db.delete_column(u'data_drivers_source', 'schedule_week')

        # Deleting field 'Source.schedule_dow'
        db.delete_column(u'data_drivers_source', 'schedule_dow')

        # Deleting field 'Source.schedule_hour'
        db.delete_column(u'data_drivers_source', 'schedule_hour')

        # Deleting field 'Source.schedule_minute'
        db.delete_column(u'data_drivers_source', 'schedule_minute')

        # Deleting field 'Source.schedule_second'
        db.delete_column(u'data_drivers_source', 'schedule_second')
    ...
    models = {
        ...
        u'data_drivers.source': {
            ...
            'schedule_day': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            'schedule_dow': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            'schedule_hour': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            'schedule_minute': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            'schedule_month': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            'schedule_second': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            'schedule_week': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            'schedule_year': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),

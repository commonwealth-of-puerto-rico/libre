...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LeafletMarker.slug'
        db.add_column(u'data_drivers_leafletmarker', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=1, unique=True, max_length=50),
                      keep_default=False)

        # Adding field 'LeafletMarker.label'
        db.add_column(u'data_drivers_leafletmarker', 'label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=48, blank=True),
                      keep_default=False)

        # Adding field 'LeafletMarker.icon_anchor_x'
        db.add_column(u'data_drivers_leafletmarker', 'icon_anchor_x',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeafletMarker.icon_anchor_y'
        db.add_column(u'data_drivers_leafletmarker', 'icon_anchor_y',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LeafletMarker.slug'
        db.delete_column(u'data_drivers_leafletmarker', 'slug')

        # Deleting field 'LeafletMarker.label'
        db.delete_column(u'data_drivers_leafletmarker', 'label')

        # Deleting field 'LeafletMarker.icon_anchor_x'
        db.delete_column(u'data_drivers_leafletmarker', 'icon_anchor_x')

        # Deleting field 'LeafletMarker.icon_anchor_y'
        db.delete_column(u'data_drivers_leafletmarker', 'icon_anchor_y')

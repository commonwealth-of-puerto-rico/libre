...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShapefileColumn.skip_regex'
        db.add_column(u'data_drivers_shapefilecolumn', 'skip_regex',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True, null=True),
                      keep_default=False)

        # Adding field 'ShapefileColumn.import_regex'
        db.add_column(u'data_drivers_shapefilecolumn', 'import_regex',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShapefileColumn.skip_regex'
        db.delete_column(u'data_drivers_shapefilecolumn', 'skip_regex')

        # Deleting field 'ShapefileColumn.import_regex'
        db.delete_column(u'data_drivers_shapefilecolumn', 'import_regex')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CSVColumn.skip_regex'
        db.add_column(u'data_drivers_csvcolumn', 'skip_regex',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True, null=True),
                      keep_default=False)

        # Adding field 'CSVColumn.import_regex'
        db.add_column(u'data_drivers_csvcolumn', 'import_regex',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CSVColumn.skip_regex'
        db.delete_column(u'data_drivers_csvcolumn', 'skip_regex')

        # Deleting field 'CSVColumn.import_regex'
        db.delete_column(u'data_drivers_csvcolumn', 'import_regex')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.limit'
        db.add_column(u'data_drivers_source', 'limit',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=50),
                      keep_default=False)

        # Deleting field 'SourceCSV.limit'
        db.delete_column(u'data_drivers_sourcecsv', 'limit')

        # Deleting field 'SourceShape.limit'
        db.delete_column(u'data_drivers_sourceshape', 'limit')

        # Deleting field 'SourceSpreadsheet.limit'
        db.delete_column(u'data_drivers_sourcespreadsheet', 'limit')

        # Deleting field 'SourceFixedWidth.limit'
        db.delete_column(u'data_drivers_sourcefixedwidth', 'limit')

        # Deleting field 'SourceDatabase.limit'
        db.delete_column(u'data_drivers_sourcedatabase', 'limit')


    def backwards(self, orm):
        # Deleting field 'Source.limit'
        db.delete_column(u'data_drivers_source', 'limit')

        # Adding field 'SourceCSV.limit'
        db.add_column(u'data_drivers_sourcecsv', 'limit',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=50),
                      keep_default=False)

        # Adding field 'SourceShape.limit'
        db.add_column(u'data_drivers_sourceshape', 'limit',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=50),
                      keep_default=False)

        # Adding field 'SourceSpreadsheet.limit'
        db.add_column(u'data_drivers_sourcespreadsheet', 'limit',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=50),
                      keep_default=False)

        # Adding field 'SourceFixedWidth.limit'
        db.add_column(u'data_drivers_sourcefixedwidth', 'limit',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=50),
                      keep_default=False)

        # Adding field 'SourceDatabase.limit'
        db.add_column(u'data_drivers_sourcedatabase', 'limit',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=50),
                      keep_default=False)

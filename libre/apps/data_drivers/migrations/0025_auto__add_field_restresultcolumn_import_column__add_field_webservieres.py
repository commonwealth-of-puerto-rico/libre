...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RESTResultColumn.import_column'
        db.add_column(u'data_drivers_restresultcolumn', 'import_column',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'WebServieResultColumn.import_column'
        db.add_column(u'data_drivers_webservieresultcolumn', 'import_column',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ShapefileColumn.import_column'
        db.add_column(u'data_drivers_shapefilecolumn', 'import_column',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'SpreadsheetColumn.import_column'
        db.add_column(u'data_drivers_spreadsheetcolumn', 'import_column',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'CSVColumn.import_column'
        db.add_column(u'data_drivers_csvcolumn', 'import_column',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'DatabaseResultColumn.import_column'
        db.add_column(u'data_drivers_databaseresultcolumn', 'import_column',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'FixedWidthColumn.import_column'
        db.add_column(u'data_drivers_fixedwidthcolumn', 'import_column',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RESTResultColumn.import_column'
        db.delete_column(u'data_drivers_restresultcolumn', 'import_column')

        # Deleting field 'WebServieResultColumn.import_column'
        db.delete_column(u'data_drivers_webservieresultcolumn', 'import_column')

        # Deleting field 'ShapefileColumn.import_column'
        db.delete_column(u'data_drivers_shapefilecolumn', 'import_column')

        # Deleting field 'SpreadsheetColumn.import_column'
        db.delete_column(u'data_drivers_spreadsheetcolumn', 'import_column')

        # Deleting field 'CSVColumn.import_column'
        db.delete_column(u'data_drivers_csvcolumn', 'import_column')

        # Deleting field 'DatabaseResultColumn.import_column'
        db.delete_column(u'data_drivers_databaseresultcolumn', 'import_column')

        # Deleting field 'FixedWidthColumn.import_column'
        db.delete_column(u'data_drivers_fixedwidthcolumn', 'import_column')

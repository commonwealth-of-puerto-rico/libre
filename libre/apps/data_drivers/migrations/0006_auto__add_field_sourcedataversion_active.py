...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceDataVersion.active'
        db.add_column(u'data_drivers_sourcedataversion', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceDataVersion.active'
        db.delete_column(u'data_drivers_sourcedataversion', 'active')
    ...
    models = {
        ...
        u'data_drivers.sourcedataversion': {
            ...
            'timestamp': ('django.db.models.fields.CharField', [], {'max_length': '14', 'blank': 'True'})
        },

...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SourceData.row'
        db.alter_column(u'data_drivers_sourcedata', 'row', self.gf('messagepack_field.fields.MessagePackField')())

        # Changing field 'SourceDataVersion.metadata'
        db.alter_column(u'data_drivers_sourcedataversion', 'metadata', self.gf('messagepack_field.fields.MessagePackField')())
    ...
    models = {
        ...
        u'data_drivers.sourcedataversion': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 15, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

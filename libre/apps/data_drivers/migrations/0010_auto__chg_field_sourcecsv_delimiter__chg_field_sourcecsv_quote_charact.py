...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SourceCSV.delimiter'
        db.alter_column(u'data_drivers_sourcecsv', 'delimiter', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'SourceCSV.quote_character'
        db.alter_column(u'data_drivers_sourcecsv', 'quote_character', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'SourceCSV.delimiter'
        db.alter_column(u'data_drivers_sourcecsv', 'delimiter', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'SourceCSV.quote_character'
        db.alter_column(u'data_drivers_sourcecsv', 'quote_character', self.gf('django.db.models.fields.CharField')(max_length=8))

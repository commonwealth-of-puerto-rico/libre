...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.description'
        db.add_column(u'data_drivers_source', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source.description'
        db.delete_column(u'data_drivers_source', 'description')

...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'data_drivers.sourcedata': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'row': ('messagepack_field.fields.MessagePackField', [], {}),
        ...
        u'data_drivers.sourcedataversion': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 14, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metadata': ('messagepack_field.fields.MessagePackField', [], {'blank': 'True'}),

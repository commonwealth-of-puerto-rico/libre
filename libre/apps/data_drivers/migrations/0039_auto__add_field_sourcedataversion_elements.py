...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'SourceDataVersion.elements'
        db.delete_column(u'data_drivers_sourcedataversion', 'elements')
    ...
    models = {
        ...
        u'data_drivers.sourcedataversion': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 14, 0, 0)'}),
            'elements': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

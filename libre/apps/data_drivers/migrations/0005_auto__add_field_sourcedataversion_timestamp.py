...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceDataVersion.timestamp'
        db.add_column(u'data_drivers_sourcedataversion', 'timestamp',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=14),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceDataVersion.timestamp'
        db.delete_column(u'data_drivers_sourcedataversion', 'timestamp')
    ...
    models = {
        ...
        u'data_drivers.sourcedataversion': {
            ...
            'timestamp': ('django.db.models.fields.CharField', [], {'max_length': '14'})
        },

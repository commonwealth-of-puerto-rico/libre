...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SourceDataVersion.timestamp'
        db.alter_column(u'data_drivers_sourcedataversion', 'timestamp', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'SourceDataVersion.timestamp'
        db.alter_column(u'data_drivers_sourcedataversion', 'timestamp', self.gf('django.db.models.fields.CharField')(max_length=14))
    ...
    models = {
        ...
        u'data_drivers.sourcedataversion': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FixedWidthColumn.location'
        db.delete_column(u'data_drivers_fixedwidthcolumn', 'location')

        # Adding field 'FixedWidthColumn.size'
        db.add_column(u'data_drivers_fixedwidthcolumn', 'size',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'FixedWidthColumn.location'
        raise RuntimeError("Cannot reverse this migration. 'FixedWidthColumn.location' and its values cannot be restored.")
        # Deleting field 'FixedWidthColumn.size'
        db.delete_column(u'data_drivers_fixedwidthcolumn', 'size')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'RESTResultColumn'
        db.delete_table(u'data_drivers_restresultcolumn')

        # Deleting model 'SourcePythonScript'
        db.delete_table(u'data_drivers_sourcepythonscript')

        # Deleting model 'WebServiceColumn'
        db.delete_table(u'data_drivers_webservicecolumn')
        ...
        # Deleting model 'SourceDatabase'
        db.delete_table(u'data_drivers_sourcedatabase')

        # Deleting model 'DatabaseResultColumn'
        db.delete_table(u'data_drivers_databaseresultcolumn')

        # Adding model 'SimpleSourceColumn'
        db.create_table(u'data_drivers_simplesourcecolumn', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('import_column', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('default', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='columns', to=orm['data_drivers.SourceSimple'])),
            ('new_name', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('data_type', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('skip_regex', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('import_regex', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'data_drivers', ['SimpleSourceColumn'])

        # Adding model 'SourceDirect'
        db.create_table(u'data_drivers_sourcedirect', (
        ...
        db.send_create_signal(u'data_drivers', ['SourceDirect'])

        # Adding model 'SourceSimple'
        db.create_table(u'data_drivers_sourcesimple', (
            (u'source_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['data_drivers.Source'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'data_drivers', ['SourceSimple'])


    def backwards(self, orm):
        # Adding model 'RESTResultColumn'
        db.create_table(u'data_drivers_restresultcolumn', (
            ('new_name', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='columns', to=orm['data_drivers.SourceRESTAPI'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('data_type', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('import_regex', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('default', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
        ...
        db.send_create_signal(u'data_drivers', ['RESTResultColumn'])
        ...
        # Adding model 'WebServiceColumn'
        db.create_table(u'data_drivers_webservicecolumn', (
            ('new_name', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='columns', to=orm['data_drivers.SourceWS'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('data_type', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('import_regex', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('default', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
        ...
        db.send_create_signal(u'data_drivers', ['WebServiceColumn'])
        ...
        # Adding model 'SourceDatabase'
        db.create_table(u'data_drivers_sourcedatabase', (
            (u'source_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['data_drivers.Source'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'data_drivers', ['SourceDatabase'])

        # Adding model 'DatabaseResultColumn'
        db.create_table(u'data_drivers_databaseresultcolumn', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('data_type', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('default', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='columns', to=orm['data_drivers.SourceDatabase'])),
            ('import_column', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'data_drivers', ['DatabaseResultColumn'])

        # Deleting model 'SimpleSourceColumn'
        db.delete_table(u'data_drivers_simplesourcecolumn')

        # Deleting model 'SourceDirect'
        db.delete_table(u'data_drivers_sourcedirect')

        # Deleting model 'SourceSimple'
        db.delete_table(u'data_drivers_sourcesimple')

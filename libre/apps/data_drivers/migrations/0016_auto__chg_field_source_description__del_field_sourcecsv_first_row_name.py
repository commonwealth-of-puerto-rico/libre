...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Source.description'
        db.alter_column(u'data_drivers_source', 'description', self.gf('django.db.models.fields.TextField')(default=''))
        # Deleting field 'SourceCSV.first_row_names'
        db.delete_column(u'data_drivers_sourcecsv', 'first_row_names')

        # Adding field 'SourceCSV.name_row'
        db.add_column(u'data_drivers_sourcecsv', 'name_row',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SourceSpreadsheet.first_row_names'
        db.delete_column(u'data_drivers_sourcespreadsheet', 'first_row_names')

        # Adding field 'SourceSpreadsheet.name_row'
        db.add_column(u'data_drivers_sourcespreadsheet', 'name_row',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SourceFixedWidth.first_row_names'
        db.delete_column(u'data_drivers_sourcefixedwidth', 'first_row_names')

        # Adding field 'SourceFixedWidth.name_row'
        db.add_column(u'data_drivers_sourcefixedwidth', 'name_row',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Source.description'
        db.alter_column(u'data_drivers_source', 'description', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding field 'SourceCSV.first_row_names'
        db.add_column(u'data_drivers_sourcecsv', 'first_row_names',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'SourceCSV.name_row'
        db.delete_column(u'data_drivers_sourcecsv', 'name_row')

        # Adding field 'SourceSpreadsheet.first_row_names'
        db.add_column(u'data_drivers_sourcespreadsheet', 'first_row_names',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'SourceSpreadsheet.name_row'
        db.delete_column(u'data_drivers_sourcespreadsheet', 'name_row')

        # Adding field 'SourceFixedWidth.first_row_names'
        db.add_column(u'data_drivers_sourcefixedwidth', 'first_row_names',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'SourceFixedWidth.name_row'
        db.delete_column(u'data_drivers_sourcefixedwidth', 'name_row')

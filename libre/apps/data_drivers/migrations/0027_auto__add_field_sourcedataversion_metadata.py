...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceDataVersion.metadata'
        db.add_column(u'data_drivers_sourcedataversion', 'metadata',
                      self.gf('jsonfield.fields.JSONField')(default={}, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceDataVersion.metadata'
        db.delete_column(u'data_drivers_sourcedataversion', 'metadata')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Source.schedule_string'
        db.add_column(u'data_drivers_source', 'schedule_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Source.schedule_enabled'
        db.add_column(u'data_drivers_source', 'schedule_enabled',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Source.schedule_string'
        db.delete_column(u'data_drivers_source', 'schedule_string')

        # Deleting field 'Source.schedule_enabled'
        db.delete_column(u'data_drivers_source', 'schedule_enabled')
    ...
    models = {
        ...
        u'data_drivers.sourcedataversion': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 7, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

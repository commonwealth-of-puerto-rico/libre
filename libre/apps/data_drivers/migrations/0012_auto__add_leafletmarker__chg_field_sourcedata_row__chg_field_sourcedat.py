...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LeafletMarker'
        db.create_table(u'data_drivers_leafletmarker', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('icon', self.gf('django.db.models.fields.related.ForeignKey')(related_name='leafletmarker-icon', to=orm['icons.Icon'])),
            ('shadow', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='leafletmarker-shadow', null=True, to=orm['icons.Icon'])),
        ))
        db.send_create_signal(u'data_drivers', ['LeafletMarker'])


        # Changing field 'SourceData.row'
        db.alter_column(u'data_drivers_sourcedata', 'row', self.gf('picklefield.fields.PickledObjectField')())

        # Changing field 'SourceDataVersion.metadata'
        db.alter_column(u'data_drivers_sourcedataversion', 'metadata', self.gf('picklefield.fields.PickledObjectField')())

    def backwards(self, orm):
        # Deleting model 'LeafletMarker'
        db.delete_table(u'data_drivers_leafletmarker')

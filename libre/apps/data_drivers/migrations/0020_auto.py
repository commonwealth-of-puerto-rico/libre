...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field allowed_groups on 'Source'
        m2m_table_name = db.shorten_name(u'data_drivers_source_allowed_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('source', models.ForeignKey(orm[u'data_drivers.source'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['source_id', 'group_id'])


    def backwards(self, orm):
        # Removing M2M table for field allowed_groups on 'Source'
        db.delete_table(db.shorten_name(u'data_drivers_source_allowed_groups'))
    ...
    models = {
        ...
        u'data_drivers.sourcedataversion': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

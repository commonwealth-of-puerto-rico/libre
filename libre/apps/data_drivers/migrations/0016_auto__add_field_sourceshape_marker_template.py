...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceShape.marker_template'
        db.add_column(u'data_drivers_sourceshape', 'marker_template',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceShape.marker_template'
        db.delete_column(u'data_drivers_sourceshape', 'marker_template')

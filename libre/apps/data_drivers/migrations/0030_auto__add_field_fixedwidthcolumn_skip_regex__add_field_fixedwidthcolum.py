...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FixedWidthColumn.skip_regex'
        db.add_column(u'data_drivers_fixedwidthcolumn', 'skip_regex',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True, null=True),
                      keep_default=False)

        # Adding field 'FixedWidthColumn.import_regex'
        db.add_column(u'data_drivers_fixedwidthcolumn', 'import_regex',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FixedWidthColumn.skip_regex'
        db.delete_column(u'data_drivers_fixedwidthcolumn', 'skip_regex')

        # Deleting field 'FixedWidthColumn.import_regex'
        db.delete_column(u'data_drivers_fixedwidthcolumn', 'import_regex')
    ...
    models = {
        ...
        u'data_drivers.sourcedataversion': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 10, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShapefileColumn.data_type'
        db.add_column(u'data_drivers_shapefilecolumn', 'data_type',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShapefileColumn.data_type'
        db.delete_column(u'data_drivers_shapefilecolumn', 'data_type')

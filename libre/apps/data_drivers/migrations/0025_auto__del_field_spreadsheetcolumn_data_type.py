...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SpreadsheetColumn.data_type'
        db.delete_column(u'data_drivers_spreadsheetcolumn', 'data_type')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SpreadsheetColumn.data_type'
        raise RuntimeError("Cannot reverse this migration. 'SpreadsheetColumn.data_type' and its values cannot be restored.")

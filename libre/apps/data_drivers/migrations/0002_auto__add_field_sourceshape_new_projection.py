...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceShape.new_projection'
        db.add_column(u'data_drivers_sourceshape', 'new_projection',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceShape.new_projection'
        db.delete_column(u'data_drivers_sourceshape', 'new_projection')
